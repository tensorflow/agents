...
class PiecewiseStochasticEnvironmentTest(
  ...
  def testObservationAndRewardsVary(
    ...
    for t in range(interval // batch_size, 10, interval // batch_size):
      ...
      self.assertNotAllClose(
          additive_reward_samples[int(t) - 1], additive_reward_samples[int(t)]
      )
  ...
  @parameterized.named_parameters(
      ...
      dict(
          testcase_name='_observation_[7]_action_[5]_batch_32',
          observation_shape=[7],
          action_shape=[5],
          batch_size=32,
      ),
