...
class DuelingQNetwork(q_network.QNetwork):
  ...
  def __init__(
    ...
    # Add a dense layer to the encoding network, in parallel to the q_value_layer
    # This 'dueling' layer estimates the state value for the input
  ...
  def call(self, observation, step_type=None, network_state=(), training=False):
    ...
    advantage = state_value + (q_values - tf.reduce_mean(q_values, axis=1, keepdims=True))
