...
class ActorTest(test_utils.TestCase):
  ...
  def testActorRun(self):
    ...
    env, agent, train_step, replay_buffer, rb_observer = self._build_components(
        rb_port
    )
  ...
  def testRefereneMetricsNotInObservers(self):
    ...
    env, agent, train_step, _, rb_observer = self._build_components(rb_port)
  ...
  def testEvalLocalPyActorRun(self):
    ...
    env, agent, train_step, replay_buffer, _ = self._build_components(rb_port)
