...
class GymWrapper(py_environment.PyEnvironment):
  ...
  def _step(self, action):
    ...
    # fix issue 282:
    # Some environments (e.g. FrozenLake) use the action as index to transition probability
    # so it has to be hashable. in Discrete case, it is a numpy scalar (e.g array(2)) thus not hashable
    # in this case, it has to be converted to hashable.
