...
* <b>`mask`</b>: A boolean mask. False/0 values mean a position should be masked out.
* <b>`probs`</b>: Must be `None`. Required to conform with base
...
* <b>`neg_inf`</b>: None or Float. Value used to mask out invalid positions. If None,
