...
<meta itemprop="name" content="tf_agents.agents.ddpg.actor_rnn_network.ActorRnnNetwork" />
...
Defined in [`agents/ddpg/actor_rnn_network.py`](https://github.com/tensorflow/agents/tree/master/tf_agents/agents/ddpg/actor_rnn_network.py).
