...
* <b>`discrete_projection_net`</b>: Callable that generates a discrete projection
    network to be called with some hidden state and the outer_rank of the
    state.
* <b>`continuous_projection_net`</b>: Callable that generates a continuous projection
    network to be called with some hidden state and the outer_rank of the
    state.
