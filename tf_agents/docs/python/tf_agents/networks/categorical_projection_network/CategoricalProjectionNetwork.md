...
<meta itemprop="name" content="tf_agents.networks.categorical_projection_network.CategoricalProjectionNetwork" />
...
*   <b>`logits_init_output_factor`</b>: Output factor for initializing kernel
    logits weights.
