...
<meta itemprop="name" content="tf_agents.policies.ou_noise_policy.OUNoisePolicy" />
...
* <b>`wrapped_policy`</b>: A policy to wrap and add OU noise to.
* <b>`ou_stddev`</b>:  stddev for the Ornstein-Uhlenbeck noise.
* <b>`ou_damping`</b>: damping factor for the Ornstein-Uhlenbeck noise.
